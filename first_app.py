...
checking_manpower = st.sidebar.number_input('Number of employees working for: checking (a checker both checks and labels)', step = 0.5, min_value = 1)
putaway_manpower = st.sidebar.number_input('Number of employees working for: put away', step = 0.5, min_value = 1)
